...
const OS_TOKEN = new InjectionToken("os");
...
class ColorUtils {
    ...
    static isDarkColor(color) {
        const c = ColorUtils.convertColor(color).substring(1); // strip #
    ...
    static ligthenColor(color) {
        return color;
    }
    static transparentize(color, amount) {
        const c = ColorUtils.hexToRgb(color);
...
class NgxDesktopMousedownDirective {
    constructor() {
...
class NgxDesktopWindowBlurDirective {
...
class NgxDesktopMouseoverDirective {
    constructor(ngxDesktopService) {
        this.ngxDesktopService = ngxDesktopService;
...
class NgxDesktopHorizontalAlignmentDirective {
    constructor(ngxDesktopService) {
        this.ngxDesktopService = ngxDesktopService;
    }
...
class NgxDesktopVerticalAlignmentDirective {
    constructor(ngxDesktopService) {
        this.ngxDesktopService = ngxDesktopService;
    }
...
function CheckboxComponent_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(2);
    ɵɵattribute("fill", ctx_r0.disabled ? "#8d8d8d" : ctx_r0.windowBlur ? "#404040" : "#FFFFFF");
    ɵɵadvance(2);
    ɵɵattribute("fill", ctx_r0.disabled ? "#ededed" : ctx_r0.checked ? ctx_r0.windowBlur ? "#FFFFFF" : "#0050a5" : "#0050a5");
} }
function CheckboxComponent__svg_svg_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵattribute("fill", ctx_r1.disabled ? "#8d8d8d" : ctx_r1.isDarkColor ? "#000" : "#fff");
} }
...
const _c0$3 = [[["ngx-desktop-nav-pane-item"]]];
const _c1 = ["ngx-desktop-nav-pane-item"];
class NavPaneItemComponent {
    constructor(ngxDesktopService) {
        this.ngxDesktopService = ngxDesktopService;
...
const _c0$4 = [[["ngx-desktop-nav-pane-item"]]];
const _c1$1 = ["ngx-desktop-nav-pane-item"];
class NavPaneComponent {
    constructor(ngxDesktopService) {
        this.ngxDesktopService = ngxDesktopService;
...
BezierEasing.prototype = {
    get: function (x) {
        let mX1 = this._p[0], mY1 = this._p[1], mX2 = this._p[2], mY2 = this._p[3];
...
function animate(elements) {
    ...
    animations$1[this.id] = setInterval(() => animateStep.apply(this, [elements]), 1000 / framerate);
}
...
function startAnimation2(...elements) {
    let id = 0;
    if (ids$1.length) {
...
class ControlValueAccessorAbstractComponent {
    constructor() {
        this.onTouchedCallback = noop;
        this.onChangeCallback = noop;
    }
...
function RadioComponent_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(2);
    ɵɵattribute("fill", ctx_r24.disabled ? ctx_r24.checked ? "#919191" : "#FFFFFF" : ctx_r24.checked ? ctx_r24.windowBlur ? "#404040" : "#FFFFFF" : "#FFFFFF");
    ɵɵadvance(2);
    ɵɵattribute("fill", ctx_r24.disabled ? ctx_r24.checked ? "#ededed" : "#ffffff" : ctx_r24.checked ? ctx_r24.windowBlur ? "#FFFFFF" : "#0050a5" : "#FFFFFF");
} }
class RadioComponent extends ControlValueAccessorAbstractComponent {
    constructor(ngxDesktopService, changeDetectorRef) {
        super();
        this.ngxDesktopService = ngxDesktopService;
        this.changeDetectorRef = changeDetectorRef;
...
RadioComponent.ɵcmp = ɵɵdefineComponent({ type: RadioComponent, selectors: [["ngx-desktop-radio"]], viewQuery: function RadioComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵɵlistener("change", function RadioComponent_Template_input_change_3_listener() { ɵɵrestoreView(_r25); const _r22 = ɵɵreference(4); _r22.checked = true; ctx.checked = true; return ctx.changeValue(ctx.value); });
        ɵɵelementEnd();
...
function SearchFieldComponent_ng_container_13_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵproperty("ngTemplateOutlet", ctx_r26.icon);
} }
...
function SegmentedControlComponent_div_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("mousedown", function SegmentedControlComponent_div_8_Template_div_mousedown_0_listener() { const segmented_r30 = ctx.$implicit; return segmented_r30.labelMousedown = true; })("click", function SegmentedControlComponent_div_8_Template_div_click_0_listener() { ɵɵrestoreView(_r34); const i_r31 = ctx.index; const segmented_r30 = ctx.$implicit; const ctx_r33 = ɵɵnextContext(); return ctx_r33.selectTab(i_r31, segmented_r30); });
    ɵɵtext(1);
    ɵɵelementEnd();
} if (rf & 2) {
    ...
    ɵɵclassProp("disabled", segmented_r30.disabled)("selected", i_r31 === ctx_r29.model)("mousedown", segmented_r30.labelMousedown)("blur", ctx_r29.windowBlur);
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", segmented_r30.label, " ");
} }
const _c0$8 = ["*"];
class SegmentedControlComponent extends ControlValueAccessorAbstractComponent {
    constructor() {
        super();
        this.height = '100%';
        this.width = '100%';
...
function TitleBarComponent_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵnextContext();
    const _r40 = ɵɵreference(8);
    ɵɵadvance(1);
    ɵɵproperty("ngTemplateOutlet", _r40);
} }
...
function TitleBarComponent_ng_container_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("ngxDesktopMousedown", function TitleBarComponent_ng_container_3_Template_a_ngxDesktopMousedown_1_listener($event) { ɵɵrestoreView(_r46); const ctx_r45 = ɵɵnextContext(); return ctx_r45.closeMousedown = $event; })("click", function TitleBarComponent_ng_container_3_Template_a_click_1_listener() { ɵɵrestoreView(_r46); const ctx_r47 = ɵɵnextContext(); return ctx_r47.onCloseClick.emit(); });
    ɵɵnamespaceSVG();
    ...
    ɵɵlistener("ngxDesktopMousedown", function TitleBarComponent_ng_container_3_Template_a_ngxDesktopMousedown_4_listener($event) { ɵɵrestoreView(_r46); const ctx_r48 = ɵɵnextContext(); return ctx_r48.minimizeMousedown = $event; })("click", function TitleBarComponent_ng_container_3_Template_a_click_4_listener() { ɵɵrestoreView(_r46); const ctx_r49 = ɵɵnextContext(); return ctx_r49.onMinimizeClick.emit(); });
    ɵɵnamespaceSVG();
    ...
    ɵɵlistener("ngxDesktopMousedown", function TitleBarComponent_ng_container_3_Template_a_ngxDesktopMousedown_7_listener($event) { ɵɵrestoreView(_r46); const ctx_r50 = ɵɵnextContext(); return ctx_r50.maximizeMousedown = $event; })("click", function TitleBarComponent_ng_container_3_Template_a_click_7_listener() { ɵɵrestoreView(_r46); const ctx_r51 = ɵɵnextContext(); return ctx_r51.triggerMaximize(); });
    ...
    ɵɵadvance(1);
    ɵɵclassProp("closeMousedown", ctx_r36.closeMousedown);
    ɵɵadvance(3);
    ɵɵclassProp("minimizeMousedown", ctx_r36.minimizeMousedown);
    ɵɵadvance(3);
    ɵɵclassProp("maximizeMousedown", ctx_r36.maximizeMousedown);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r36.maximized);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", !ctx_r36.maximized);
} }
function TitleBarComponent_ng_container_4__svg_svg_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵattribute("fill", ctx_r52.windowBlur ? "rgba(0, 0, 0, .4)" : "rgba(0, 0, 0)");
} }
function TitleBarComponent_ng_container_4__svg_svg_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵattribute("fill", ctx_r53.windowBlur ? "rgba(0, 0, 0, .4)" : "rgba(0, 0, 0)");
} }
function TitleBarComponent_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    const _r55 = ɵɵgetCurrentView();
    ɵɵelementContainerStart(0);
    ɵɵelementStart(1, "a", 17);
    ɵɵlistener("ngxDesktopMousedown", function TitleBarComponent_ng_container_4_Template_a_ngxDesktopMousedown_1_listener($event) { ɵɵrestoreView(_r55); const ctx_r54 = ɵɵnextContext(); return ctx_r54.minimizeMousedown = $event; })("ngxDesktopMouseover", function TitleBarComponent_ng_container_4_Template_a_ngxDesktopMouseover_1_listener($event) { ɵɵrestoreView(_r55); const ctx_r56 = ɵɵnextContext(); return ctx_r56.minimizeMouseover = $event; })("click", function TitleBarComponent_ng_container_4_Template_a_click_1_listener() { ɵɵrestoreView(_r55); const ctx_r57 = ɵɵnextContext(); return ctx_r57.onMinimizeClick.emit(); });
    ɵɵnamespaceSVG();
    ...
    ɵɵlistener("ngxDesktopMousedown", function TitleBarComponent_ng_container_4_Template_a_ngxDesktopMousedown_4_listener($event) { ɵɵrestoreView(_r55); const ctx_r58 = ɵɵnextContext(); return ctx_r58.maximizeMousedown = $event; })("ngxDesktopMouseover", function TitleBarComponent_ng_container_4_Template_a_ngxDesktopMouseover_4_listener($event) { ɵɵrestoreView(_r55); const ctx_r59 = ɵɵnextContext(); return ctx_r59.maximizeMouseover = $event; })("click", function TitleBarComponent_ng_container_4_Template_a_click_4_listener() { ɵɵrestoreView(_r55); const ctx_r60 = ɵɵnextContext(); return ctx_r60.triggerMaximize(); });
    ...
    ɵɵlistener("ngxDesktopMousedown", function TitleBarComponent_ng_container_4_Template_a_ngxDesktopMousedown_7_listener($event) { ɵɵrestoreView(_r55); const ctx_r61 = ɵɵnextContext(); return ctx_r61.closeMousedown = $event; })("ngxDesktopMouseover", function TitleBarComponent_ng_container_4_Template_a_ngxDesktopMouseover_7_listener($event) { ɵɵrestoreView(_r55); const ctx_r62 = ɵɵnextContext(); return ctx_r62.closeMouseover = $event; })("click", function TitleBarComponent_ng_container_4_Template_a_click_7_listener() { ɵɵrestoreView(_r55); const ctx_r63 = ɵɵnextContext(); return ctx_r63.onCloseClick.emit(); });
    ɵɵnamespaceSVG();
    ...
    ɵɵadvance(1);
    ɵɵclassProp("minimizeMousedown", ctx_r37.minimizeMousedown)("minimizeMouseover", ctx_r37.minimizeMouseover);
    ɵɵadvance(2);
    ɵɵattribute("fill", ctx_r37.windowBlur ? "rgba(0, 0, 0, .4)" : "rgba(0, 0, 0)");
    ɵɵadvance(1);
    ɵɵclassProp("maximizeMousedown", ctx_r37.maximizeMousedown)("maximizeMouseover", ctx_r37.maximizeMouseover);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", !ctx_r37.maximized);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r37.maximized);
    ɵɵadvance(1);
    ɵɵclassProp("closeMousedown", ctx_r37.closeMousedown)("closeMouseover", ctx_r37.closeMouseover);
    ɵɵadvance(2);
    ɵɵattribute("fill", ctx_r37.windowBlur ? "rgba(0, 0, 0, .4)" : "rgba(0, 0, 0)");
} }
...
function TitleBarComponent_ng_template_7_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", ctx_r65.title, " ");
} }
function TitleBarComponent_ng_template_7_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("ngIf", ctx_r41.title || ctx_r41.os === "windows");
} }
const _c0$b = [[["ngx-desktop-toolbar"]]];
const _c1$2 = ["ngx-desktop-toolbar"];
...
function ToolbarNavComponent_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("click", function ToolbarNavComponent_div_3_Template_a_click_1_listener() { ɵɵrestoreView(_r71); const i_r68 = ctx.index; const ctx_r70 = ɵɵnextContext(); ctx_r70.selectedIndex = i_r68; return ctx_r70.selectedIndexChange.emit(i_r68); });
    ...
    ɵɵclassProp("selected", i_r68 === ctx_r66.selectedIndex);
    ɵɵadvance(3);
    ɵɵproperty("ngTemplateOutlet", toolbarNavItemComponent_r67.icon);
    ɵɵadvance(2);
    ɵɵtextInterpolate1(" ", toolbarNavItemComponent_r67.title, " ");
} }
class ToolbarNavComponent {
    constructor() {
...
class NgxDesktopLayoutDirective {
    constructor() {
    }
...
const _c0$d = [[["ngx-desktop-title-bar"]], "*"];
const _c1$3 = ["ngx-desktop-title-bar", "*"];
...
class NgxDesktopFocusDirective {
    constructor(ngxDesktopService) {
        this.ngxDesktopService = ngxDesktopService;
...
class NgxDesktopHeightDirective {
    constructor(ngxDesktopService) {
        this.ngxDesktopService = ngxDesktopService;
    }
...
class NgxDesktopMarginDirective {
    constructor(ngxDesktopService) {
        this.ngxDesktopService = ngxDesktopService;
...
class NgxDesktopOsClassDirective {
...
class NgxDesktopPaddingDirective {
    constructor(ngxDesktopService) {
        this.ngxDesktopService = ngxDesktopService;
...
class NgxDesktopWidthDirective {
    constructor(ngxDesktopService) {
        this.ngxDesktopService = ngxDesktopService;
    }
